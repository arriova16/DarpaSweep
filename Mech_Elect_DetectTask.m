...
% monkey_name = {'Pinot', 'Whistlepig'};

% monkey_files = fullfile(data_folder, monkey_name);
% for m = 1:size(monkey_files,2)
%      electrode_list = fullfile(data_folder,monkey_files(m),'Electrode*'); 
%      % for i = 1:size(electrode_list)
%      % 
%      % 
%      % end
% end
