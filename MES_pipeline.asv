...
sweep_df = 'C:\Users\arrio\Box\BensmaiaLab\ProjectFolders\DARPA\Data\ProcessedData\Whistlepig\DarpaSweep\Electrode_41and42';
...
text(.01,1,(sprintf('%.3f', mq(m))), 'Color', rgb(233, 30, 99));
...
plot([0 dprime_big(2,1) dprime_big(2,1)], [dprime_big(2,1) dprime_big(2,1) -1],'LineStyle','--', 'Color', rgb(233, 30, 99))
